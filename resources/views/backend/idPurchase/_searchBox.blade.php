<div class="row">
    <form action="{{ route('idPurchase.index') }}" method="get" id="frmSearchIdPurchases">
        ...
        <div class="col-md-5 col-sm-12">
            <div class="table-group-actions pull-right">
                ...
                <button class="btn btn-sm red table-group-actions" v-on:click="deleteSelectedIdPurchases" type="button">
