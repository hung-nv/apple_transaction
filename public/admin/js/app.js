...
for (var pageId in dispatcher_1.default) {
    ...
    pageModulers[pageId] = __webpack_require__(343)("./" + path).default;
}
...
Object.defineProperty(exports, "__esModule", { value: true });
// Import vendor.
var vue_1 = __webpack_require__(339);
var defaultOptions = [
    'setUp',
    'events',
    'data',
...
var CreditCard = /** @class */ (function () {
    ...
    CreditCard.prototype.setUp = function () {
    };
    CreditCard.prototype.confirmDelete = function (event) {
...
var idApple = /** @class */ (function () {
    ...
    idApple.prototype.confirmDelete = function (event) {
        helpers_1.confirmBeforeDelete(event.target, 'Do you want to delete this?');
    };
    idApple.prototype.selectIdApple = function (event) {
...
Object.defineProperty(exports, "__esModule", { value: true });
var helpers_1 = __webpack_require__(49);
var IphoneInformation = /** @class */ (function () {
    function IphoneInformation() {
    }
    IphoneInformation.prototype.setUp = function () {
    };
    IphoneInformation.prototype.confirmDelete = function (event) {
        helpers_1.confirmBeforeDelete(event.target, 'Do you want to delete this?');
    };
    return IphoneInformation;
}());
exports.default = IphoneInformation;
...
/* WEBPACK VAR INJECTION */}.call(__webpack_exports__, __webpack_require__(94), __webpack_require__(340).setImmediate))
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(94), __webpack_require__(342)))
...
var map = {
	...
	"./utilities/common/helpers": 49,
	"./utilities/common/helpers.ts": 49,
	"./utilities/dialog/DialogOptionInterface": 134,
	"./utilities/dialog/DialogOptionInterface.ts": 134,
	"./utilities/dialog/dialog": 95,
	"./utilities/dialog/dialog.ts": 95,
	"./utilities/dialog/example": 135,
	"./utilities/dialog/example.ts": 135,
	"./utilities/form_watcher/form_watcher": 136,
	"./utilities/form_watcher/form_watcher.ts": 136,
	"./utilities/formater/formater": 137,
	"./utilities/formater/formater.ts": 137,
	"./utilities/image/image": 138,
	"./utilities/image/image.ts": 138,
	"./utilities/mixins/mixins": 139,
	"./utilities/mixins/mixins.ts": 139,
	"./utilities/validate_rule/rules": 140,
	"./utilities/validate_rule/rules.ts": 140
};
